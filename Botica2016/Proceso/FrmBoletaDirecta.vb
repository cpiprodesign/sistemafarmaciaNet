...
Public Class FrmBoletaDirecta
    ...
    Private Sub btnagregar_Click(sender As Object, e As EventArgs) Handles btnagregar.Click
        ...
        Dim CODPRO As String : Dim R As String
        Dim i As Integer
        a = (txtcantidad.Text)
        b = Lbstock.Text
    ...
    Private Sub pdt_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles pdt.PrintPage
        ...
        stbsalto.Length = 0
        '------------
        stbDetalle.Append("Nombres : " & Me.LblCliente.Text)
        ...
        stbsalto.Length = 0
        '----------------------
        stbDetalle.Append("Ruc: " & Me.LblRuc.Text)
        txtdetalle = stbDetalle.ToString
        e.Graphics.DrawString(txtdetalle, Fuente, Brocha, X, Y)
        Y = Y + Fuente.GetHeight
        stbDetalle.Length = 0
        ...
        For i = 0 To carrito.Rows.Count - 1
            ...
            stb.Append(carrito.Rows(i)(1).ToString.PadRight(25))
            stb.Append(carrito.Rows(i)(2).ToString.PadRight(40))
        ...
        stbpago.Append("Total : " & Me.lbltotal.Text)
